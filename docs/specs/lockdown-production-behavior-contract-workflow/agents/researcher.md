...
Answer bounded blockers around Chrome MV3, Chrome Web Store policy, kiosk deployment, Firebase trusted APIs, or YouTube resolution without drifting into implementation.
