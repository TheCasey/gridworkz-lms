...
Implement only the active Lockdown phase, preserve the route-backed dashboard shell and trusted device-policy boundary, and add focused validation scripts or tests for behavior changes.
