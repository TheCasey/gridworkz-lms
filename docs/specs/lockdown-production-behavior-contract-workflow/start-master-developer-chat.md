...
- `phases/phase-01-state-vocabulary-and-active-work-contract/phase.md`
- `phases/phase-01-state-vocabulary-and-active-work-contract/run-log.md`
...
- Working branch target: `codex/lockdown-production-behavior-contract`
- Commit mode: `phase_acceptance`
- Push mode: `accepted_phase`
- PR mode: `draft_on_first_push`
- Branch bootstrap status: `automatic branch creation disabled because the behavior-contract docs were already dirty`
...
- Create or switch to `codex/lockdown-production-behavior-contract` only after the current documentation scaffold is accepted or the user asks for a branch now.
