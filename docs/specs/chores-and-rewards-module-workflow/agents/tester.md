...
Validate only the active phase, confirm tests or no-test rationale are meaningful, perform declared browser/API/security checks, update the run log, and return control to master-developer.
