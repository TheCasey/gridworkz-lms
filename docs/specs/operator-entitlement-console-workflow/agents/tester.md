...
Validate only the active phase, verify lint/build and any added helper checks, and return concrete evidence for operator authorization, entitlement resolution, and UI behavior.
