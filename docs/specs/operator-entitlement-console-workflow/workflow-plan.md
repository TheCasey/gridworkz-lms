...
| [Phase 2: Entitlement Resolution And Audit](phases/phase-02-entitlement-resolution-and-audit/phase.md) | `developer -> tester` | `build-health`, `code-review`, `api-smoke` | operator-trust-boundary | `ready_for_master_developer` |
| [Phase 3: Operator Functions](phases/phase-03-operator-functions/phase.md) | `developer -> tester` | `build-health`, `api-smoke`, `code-review` | entitlement-resolution-and-audit | `pending` |
| [Phase 4: Ops Entitlements UI](phases/phase-04-ops-entitlements-ui/phase.md) | `developer -> tester` | `build-health`, `browser-smoke`, `interaction-smoke` | operator-functions | `pending` |
