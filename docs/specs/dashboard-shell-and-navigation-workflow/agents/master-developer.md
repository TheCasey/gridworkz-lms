...
Own shell-level orchestration, validate phase scope against the shell and homeschool specs, keep route and navigation changes coherent, and manage state transitions plus git checkpoints.
