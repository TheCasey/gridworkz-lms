...
| `ownpath_homeschool_overview.html` | `/dashboard/homeschool` | `src/pages/dashboard/HomeschoolRoute.jsx`, `src/hooks/useWeeklyActivity.js`, `src/hooks/useWeeklyPlansForWeek.js`, `src/hooks/useWeeklyReportRecords.js` | Prototype console pass landed: compact topbar, week/setup status banner, dense navigation strip, stats, subject coverage, setup notes, and recent subject records. Links to Curriculum, Weekly Blocking, and Reports. |
...
| `ownpath_chores_overview.html` | `/dashboard/chores` | `src/pages/dashboard/ChoresRoute.jsx`, `src/hooks/useChoreSetup.js`, `src/utils/choreParentViewModel.js`, `src/utils/choreUtils.js`, `src/utils/rewardUtils.js` | Prototype overview pass landed: compact chores topbar/subbar, five-card stats strip, five-card navigation strip, student snapshot list, focused-student panel, and activity feed derived from pending reviews, allowance, and rewards while preserving existing route branching and handlers. |
