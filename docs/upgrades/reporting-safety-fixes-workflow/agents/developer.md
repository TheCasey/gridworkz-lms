...
Implement only the active reporting safety slice, preserve existing report filters and print surfaces, and add focused helper checks when reporting logic is extracted.
