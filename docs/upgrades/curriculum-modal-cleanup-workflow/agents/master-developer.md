...
Own workflow orchestration and keep this cleanup scoped to the current subject editor instead of turning it into a new curriculum-template or weekly-plan architecture project.
