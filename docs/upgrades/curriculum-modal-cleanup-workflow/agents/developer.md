...
Implement only the active UI cleanup phase, preserve current subject write shape and weekly-plan derivation, and keep design consistent with the existing parent dashboard palette.
